                        ...
                        <div class="category">
                            <div class="ht__cat__thumb">
                                <a href="product-details.php">
                                    <img src="admin/php/Images/new_arrival/" alt="product images">
                                </a>
                            </div>
                            ...
                            <div class="fr__product__inner">
                                <h4><a href="product-details.php"><?php echo $b[2]; ?></a></h4>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="section__title--2 text-center">
                    ...
                    <p><p><u><a href="#">View more</a></u></p></p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="product__wrap clearfix">
                ...
                <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12" data-aos="fade-up" data-aos-duration="1000">
                    <div class="category">
                        <div class="ht__cat__thumb">
                            <a href="product-details.php">
                                <img src="admin/php/Images/new_arrival/<?php echo $d[4]; ?>"; ?>"alt="product images">
                            </a>
                        </div>
                        <div class="fr__hover__info">
                            <ul class="product__action">
                        ...
                        <div class="fr__product__inner">
                            <h4><a href="product-details.php"><?php echo $d[2]; ?></a></h4>
                            <ul class="fr__pro__prize">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" data-aos="flip-down" data-aos-duration="1000">
                <div class="htc__best__product">
                    <div class="htc__best__pro__thumb">
                        <a href="product-details.php">
                            <img src="admin/php/Images/new_arrival/<?php echo $e[4]; ?>"alt="small product">
                        </a>
                    </div>
                    <div class="htc__best__product__details">
                        <h2><a href="product-details.php"><?php echo $e[2]; ?></a></h2>
                        <ul class="rating">
