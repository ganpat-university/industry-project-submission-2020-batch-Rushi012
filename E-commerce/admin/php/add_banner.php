            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Add-Banner</h4>
                    </div>
                   ...
                   <div class="row">
                    ...
                    <div class="card-body">
                         ...
                         $destination = 'Images/banner/' . $image1;
                         ...
                         $sql =  $sql = "INSERT INTO `banner`(`image`) VALUES ('$image1')";
                                   echo $sql; 
                                    if (mysqli_query($con, $sql)) {
                                        echo"<script>alert('Your bannerhas ben uploaded')</script>";
                                       echo"<script>window.location ='Home_page.php'</script>";
